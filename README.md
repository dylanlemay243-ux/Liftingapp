...
- **Today dashboard** — runs the right session for the weekday; shows next move, completion, readiness/power signals, quick actions, per-exercise overload recommendations, and exercise swaps
